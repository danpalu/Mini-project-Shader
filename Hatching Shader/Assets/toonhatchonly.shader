Shader "Unlit/Toon Cell"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Returns the hatching pattern
            float3 Hatching (float2 uv, float lightIntensity)
            {
                // Sampling the two textures
                ...
                float hatch = maxBrightness + hatch0.r * _Tune1 + hatch0.g * _Tune2 + hatch0.b * _Tune3 + hatch1.r * _Tune4 + hatch1.g * _Tune5 + hatch1.b * _Tune6; 
                hatch = (hatch);
                return hatch;
            }
